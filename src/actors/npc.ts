...
export interface NpcSchema extends foundry.data.fields.DataSchema {
	xp: number;
	level: number;
	health: {
		value: number;
...
export class NpcDataModel extends TypeDataModel<NpcSchema, Actor> {
	...
	static migrateData(source: NpcSchema): NpcSchema {
